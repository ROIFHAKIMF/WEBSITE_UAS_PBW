    ...
    <tbody>
        ...
        ?>
            <tr>
                <td><?= $no++ ?></td>
                <td>
                    <br>Judul : <?= $row["judul"]?><br>isi : <?= $row["isi"] ?><br>pada : <?= $row["tanggal"] ?>
                </td>
                <td>
                    <?php
                    if ($row["gambar"] != '') {
                    ...
                    ?>
                            <img src="image/<?= $row["gambar"] ?>" style="width:300px; height:160px;">
                    <?php
                        }
                    }
                    ?>
                ...
                <td class="">
                    <button title="edit" class="btn btn-warning rounded-pill" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $row["ID"] ?>"><i class="bi bi-pencil"></i>EDIT</button>
                    <button title="delete" class="btn btn-danger rounded-pill" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $row["ID"] ?>"><i class="bi bi-x-circle"></i>HAPUS</button>
                    <div class="modal fade" id="modalEdit<?=$row["ID"]?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content bg-warning text-start">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        if ($row["gambar"] != '') {
                            if (file_exists('image/' . $row["gambar"] . '')) {
                        ?>
                                <br><img style="width:100px; height:100px;" src="image/<?= $row["gambar"] ?>">
                        <?php
                            }
                        }
                        ?>
...
<!-- Awal Modal Hapus -->
<div class="modal fade" id="modalHapus<?=$row["ID"]?>" data-bs-backdrop="static" tabindex="-1" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
...
<nav class="mb-2">
    <ul class="pagination justify-content-end">
        ...
        if ($hlm == 1) {
            echo '<li class="page-item"><a class="page-link" href="#">First</a></li>';
            echo '<li class="page-item"><a class="page-link" href="#"><span aria-hidden="true">&laquo;</span></a></li>';
        } else {
        ...
        if ($hlm == $jumlah_page) {
            echo '<li class="page-item"><a class="page-link" href="#"><span aria-hidden="true">&raquo;</span></a></li>';
            echo '<li class="page-item"><a class="page-link" href="#">Last</a></li>';
        } else {
