<div class="container">
    ...
    <button type="button" class="btn btn-success w-25 p-2 mb-2" data-bs-toggle="modal" data-bs-target="#modalTambah">
        <i class="bi bi-plus-lg"></i> Tambah Gallery
    </button>        <!-- Awal Modal Tambah-->
        <div class="modal fade" id="modalTambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content bg-success text-start">
...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_POST['ID'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO gallery (judul,isi,gambar,tanggal,nama)
                                VALUES (?,?,?,?,?)");
